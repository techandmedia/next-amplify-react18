      ...
      >
        ...
        >
          <IconFavorite
            ...
            type="favorite"
            fontSize="24px"
            {...getOverrideProps(overrides, 'Flex.Flex[0].Flex[0].IconFavorite[0]')}
          ></IconFavorite>
          <Text
            fontFamily="Inter"
            fontSize="14px"
        ...
        >
          ...
          >
            <Flex
              ...
              position="relative"
              padding="0px 0px 0px 0px"
              {...getOverrideProps(overrides, 'Flex.Flex[1].Flex[0].Flex[0].Flex[0]')}
            >
              <Text
                fontFamily="Inter"
                fontSize="16px"
                ...
                padding="0px 0px 0px 0px"
                children="Author"
                {...getOverrideProps(overrides, 'Flex.Flex[1].Flex[0].Flex[0].Flex[0].Text[0]')}
              ></Text>
              <Text
                fontFamily="Inter"
                fontSize="16px"
                ...
                padding="0px 0px 0px 0px"
                children="Timestamp"
                {...getOverrideProps(overrides, 'Flex.Flex[1].Flex[0].Flex[0].Flex[0].Text[1]')}
              ></Text>
              <Text
                fontFamily="Inter"
                fontSize="16px"
                ...
                {...getOverrideProps(overrides, 'Flex.Flex[1].Flex[0].Flex[0].Flex[0].Text[2]')}
              ></Text>
            </Flex>
            <Flex
              gap="0"
              ...
              position="relative"
              padding="0px 0px 0px 0px"
              {...getOverrideProps(overrides, 'Flex.Flex[1].Flex[0].Flex[0].Flex[1]')}
            >
              <IconMoreHoriz
                width="24px"
                height="24px"
      ...
      >
        ...
        >
          <IconReply
            ...
            type="reply"
            fontSize="24px"
            {...getOverrideProps(overrides, 'Flex.Flex[2].Flex[0].IconReply[0]')}
          ></IconReply>
          <Text
            fontFamily="Inter"
            fontSize="16px"
        ...
        >
          <IconShuffle
            ...
            type="shuffle"
            fontSize="24px"
            {...getOverrideProps(overrides, 'Flex.Flex[2].Flex[1].IconShuffle[0]')}
          ></IconShuffle>
          <Text
            fontFamily="Inter"
            fontSize="16px"
        ...
        >
          <IconFavoriteBorder
            ...
            fontSize="24px"
            {...getOverrideProps(overrides, 'Flex.Flex[2].Flex[2].IconFavoriteBorder[0]')}
          ></IconFavoriteBorder>
          <Text
            fontFamily="Inter"
            fontSize="16px"
