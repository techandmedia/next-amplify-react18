        ...
        >
          ...
          >
            ...
            <Text
              ...
              {...getOverrideProps(overrides, 'Flex.Flex[0].Flex[0].Flex[0].Text[1]')}
            ></Text>
          </Flex>
          <Divider
            width="740px"
          ...
          >
            ...
            <Text
              ...
              {...getOverrideProps(overrides, 'Flex.Flex[0].Flex[0].Flex[1].Text[1]')}
            ></Text>
          </Flex>
          <Divider
            width="740px"
          ...
          >
            ...
            <Text
              ...
              {...getOverrideProps(overrides, 'Flex.Flex[0].Flex[0].Flex[2].Text[1]')}
            ></Text>
          </Flex>
        </Flex>
      </Flex>
        ...
        >
          ...
          >
            <Button
              ...
              variation="primary"
              children="XXS"
              {...getOverrideProps(overrides, 'Flex.Flex[1].Flex[1].Flex[0].Button[0]')}
            ></Button>
            <Button
              display="flex"
              width="75px"
              ...
              variation="primary"
              children="XS"
              {...getOverrideProps(overrides, 'Flex.Flex[1].Flex[1].Flex[0].Button[1]')}
            ></Button>
            <Button
              display="flex"
              width="74px"
              ...
              variation="primary"
              children="S"
              {...getOverrideProps(overrides, 'Flex.Flex[1].Flex[1].Flex[0].Button[2]')}
            ></Button>
            <Button
              display="flex"
              width="75px"
              ...
              variation="primary"
              children="M"
              {...getOverrideProps(overrides, 'Flex.Flex[1].Flex[1].Flex[0].Button[3]')}
            ></Button>
          </Flex>
          <Flex
            gap="24px"
          ...
          >
            <Button
              ...
              variation="primary"
              children="L"
              {...getOverrideProps(overrides, 'Flex.Flex[1].Flex[1].Flex[1].Button[0]')}
            ></Button>
            <Button
              gap="24px"
              display="flex"
              ...
              variation="primary"
              children="XL"
              {...getOverrideProps(overrides, 'Flex.Flex[1].Flex[1].Flex[1].Button[1]')}
            ></Button>
            <Button
              gap="24px"
              display="flex"
              ...
              variation="primary"
              children="2XL"
              {...getOverrideProps(overrides, 'Flex.Flex[1].Flex[1].Flex[1].Button[2]')}
            ></Button>
            <Button
              gap="24px"
              display="flex"
              ...
              variation="primary"
              children="3XL"
              {...getOverrideProps(overrides, 'Flex.Flex[1].Flex[1].Flex[1].Button[3]')}
            ></Button>
          </Flex>
          <Text
            fontFamily="Inter"
