      ...
      >
        ...
        >
          <IconMoreVert
            ...
            type="more_vert"
            fontSize="24px"
            {...getOverrideProps(overrides, 'Flex.Flex[0].Flex[1].IconMoreVert[0]')}
          ></IconMoreVert>
        </Flex>
      </Flex>
      <Image
      ...
      >
        ...
        >
          <IconFavoriteBorder
            ...
            fontSize="24px"
            {...getOverrideProps(overrides, 'Flex.Flex[1].Flex[0].IconFavoriteBorder[0]')}
          ></IconFavoriteBorder>
          <IconChatBubbleOutline
            width="24px"
            height="24px"
            ...
            fontSize="24px"
            {...getOverrideProps(overrides, 'Flex.Flex[1].Flex[0].IconChatBubbleOutline[0]')}
          ></IconChatBubbleOutline>
          <IconSend
            width="24px"
            height="24px"
        ...
        >
          <IconBookmarkBorder
            ...
            fontSize="24px"
            {...getOverrideProps(overrides, 'Flex.Flex[1].Flex[1].IconBookmarkBorder[0]')}
          ></IconBookmarkBorder>
        </Flex>
      </Flex>
      <Flex
