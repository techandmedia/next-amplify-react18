      ...
      >
        ...
        >
          <IconClose
            ...
            type="close"
            fontSize="24px"
            {...getOverrideProps(overrides, 'Flex.Flex[0].Flex[0].IconClose[0]')}
          ></IconClose>
          <Text
            fontFamily="Inter"
            fontSize="16px"
        ...
        >
          <TextField
            ...
            size="default"
            variation="default"
            {...getOverrideProps(overrides, 'Flex.Flex[0].Flex[2].TextField[0]')}
          ></TextField>
          <TextField
            label="location"
            display="flex"
            ...
            size="default"
            variation="default"
            {...getOverrideProps(overrides, 'Flex.Flex[0].Flex[2].TextField[1]')}
          ></TextField>
          <TextField
            label="email"
            display="flex"
            ...
            size="default"
            variation="default"
            {...getOverrideProps(overrides, 'Flex.Flex[0].Flex[2].TextField[2]')}
          ></TextField>
        </Flex>
        <Divider
          width="640px"
